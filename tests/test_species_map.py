...
class ProjectTests(unittest.TestCase):
    ...
    def test_build_project_with_existing_eggnog_annotations(self):
        with tempfile.TemporaryDirectory() as directory:
            ...
            self.assertIn("font: 14px ui-monospace", html)
            ...
            self.assertIn('value="unrooted">Unrooted', html)
            self.assertIn('id="horizontalSpacingDown"', html)
            self.assertIn('id="verticalSpacingUp"', html)
            ...
            self.assertIn("grid-template-columns: 34px 180px 75px", html)
