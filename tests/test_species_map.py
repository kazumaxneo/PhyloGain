...
class ProjectTests(unittest.TestCase):
    ...
    def test_build_project_with_gtdb_taxonomy(self):
        with tempfile.TemporaryDirectory() as directory:
            ...
            self.assertIn(".clade-taxonomy-band.species", html)
            self.assertIn('["family", "genus", "species"]', html)
            ...
            self.assertIn("const hueCycle = [0, 210, 110, 300", html)
    ...
    def test_build_project_with_existing_eggnog_annotations(self):
        with tempfile.TemporaryDirectory() as directory:
            ...
            self.assertIn('id="treeZoom" type="range" min="10" max="200" step="5"', html)
