...
class ProjectTests(unittest.TestCase):
    ...
    def test_build_project_with_existing_eggnog_annotations(self):
        with tempfile.TemporaryDirectory() as directory:
            ...
            self.assertIn('gene-gain-loss-tree-${state.treeLayout}-${state.branchLengthMode}.svg', html)
            ...
            self.assertIn('id="taxonomyPrefixSelect"', html)
            self.assertIn('<option value="show">Show</option><option value="hide">Hide</option>', html)
            ...
            self.assertIn('for (const [key, item] of taxonomyDisplayLegend)', html)
