...
class ProjectTests(unittest.TestCase):
    ...
    def test_build_project_with_existing_eggnog_annotations(self):
        with tempfile.TemporaryDirectory() as directory:
            ...
            self.assertIn('id="restoreLabelDefaults"', html)
            self.assertIn('state.tipLabelOverrides.clear()', html)
            self.assertIn('localStorage.removeItem("species-map-taxonomy-label-offsets")', html)
